...
# creating the frames in the window
    ...
    def startpage(self):
        ...
        datalabel=Label(window,font=('time', 8, 'bold'))
...
#show log
        ...
        self.result = self.cursor.execute(sql2)
        for self.row in self.alldata:
            self.id = self.row[0]
            ids.append(self.id)
...
# funtion to call submit button
    ...
    def add_appointment(self):
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '':
          tkinter.messagebox.showinfo("Warning", "Please Fill Up All Boxes")
            ...
            sql = "INSERT INTO appointments (id, name, age, gender, location, phone) VALUES(%s, %s, %s, %s, %s, %s )"
            self.cursor.execute(sql, ("2",self.val1, self.val2, self.val3, self.val4, self.val5))
            self.db.commit()
    ...
    def update1(self):
        ...
        # execute sql
            ...
            self.cursor.execute(sql, (self.input,))
        ...
        #buttons for update and delete
            ...
            tkinter.messagebox.showinfo("Oops!", "Something went wrong, Please check the appointment id you've entered")
    ...
    def update2(self):
            ...
            query = "UPDATE appointments SET name=%s, age=%s, gender=%s, location=%s, phone=%s WHERE id LIKE %s"
            self.cursor.execute(query, (self.var1, self.var2, self.var3, self.var4, self.var5, self.idnet.get(),))
            self.db.commit()
    ...
    def delete2(self):
        sql2 = "DELETE FROM appointments WHERE id LIKE %s"
        self.cursor.execute(sql2, (self.idnet.get(),))
        self.db.commit()
